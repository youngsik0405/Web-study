			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						{
						%>
							<input type="text" name="subject" class="boxTF" maxlength="20"
							style="width: 414px;" value="<%=dto.getSubject()%>">
						<%
						}
						else				//-- (status==2) → 삭제 요청
						{
						%>
							<input type="text" name="subject" class="boxTF" maxlength="20"
							style="width: 414px;" value="<%=dto.getSubject()%>" disabled="disabled">
						<%
						}
						%>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>
							<input type="text" name="name" class="boxTF" maxlength="20"
							style="width: 414px;" value="<%=dto.getName()%>" disabled="disabled">
						<%
						}
						%>
					</dd>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>
							<!-- check~!!! -->
							<input type="text" name="email" class="boxTF" maxlength="50"
						...
						%>
							<!-- check~!!! -->
							<input type="text" name="email" class="boxTF" maxlength="50"
							style="width: 414px;" value="<%=emailStr%>" disabled="disabled">
						<%
						}
						%>
					</dd>
			...
			<div id="bbsCreated_noLine">
				<dl>
					...
					<dd>
						...
						&nbsp;<span style="font-size: 6pt; color: red;">(게시물 수정 삭제 시 필요)</span>
					</dd>
				</dl>
