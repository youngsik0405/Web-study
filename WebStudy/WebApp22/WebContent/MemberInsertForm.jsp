...
<div>
	...
	<c:forEach var="n" begin="1" end="5" step="1">
		이름<input type="text" name="name${n}" class="txt"><br>
		전화번호<input type="text" name="tel${n}" class="txt"><br>
		주소<input type="text" name="addr${n}" class="txt"><br><br>
	</c:forEach>
		
	<button type="submit" class="btn">데이터 입력</button>
